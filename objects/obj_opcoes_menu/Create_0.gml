...
options = [
    ...
    },
    {
        ...
        action_left:  function() { global.volume_master = max(0, global.volume_master - 0.1); settings_apply(); settings_save(); },
        action_right: function() { global.volume_master = min(1, global.volume_master + 0.1); settings_apply(); settings_save(); }
    },
    {
        name: "VOLUME MÚSICA",
        type: "slider",
        get_value: function() { return string(round(global.volume_music * 100)) + "%"; },
        action_left:  function() { global.volume_music = max(0, global.volume_music - 0.1); settings_apply(); settings_save(); },
        action_right: function() { global.volume_music = min(1, global.volume_music + 0.1); settings_apply(); settings_save(); }
    },
    {
        name: "VOLUME EFEITOS",
        type: "slider",
        get_value: function() { return string(round(global.volume_sfx * 100)) + "%"; },
        action_left:  function() { global.volume_sfx = max(0, global.volume_sfx - 0.1); settings_apply(); settings_save(); },
        action_right: function() { global.volume_sfx = min(1, global.volume_sfx + 0.1); settings_apply(); settings_save(); }
    },
    {
        name: "CONTROLES",
        type: "action",
        get_value: function() { return ">"; },
        action_confirm: function() { room_goto(rm_controles); }
    },
    {
        name: "VOLTAR",
        type: "action",
        get_value: function() { return ""; },
        action_confirm: function() { room_goto(rm_menu); }
    }
];
